<h1>Current Server Setup</h1><a href="https://jackfusion.github.io/projects.html" style="text-align:right">Back to previuos page</a>
...
<p>To get node JS to work I so that I could <code> docker exec -it (container ID) /bin/bash </code> I followed this tutorial <a href="https://geshan.com.np/blog/2020/11/nodejs-with-docker/">nodejs with docker</a> but did the full version 15 as base not the alpine version because it will not work. So that you can bash into the container.</p>
